...
import { MAX_ANCILLARY_DATA, SAFETY_PERIOD, YES_OR_NO_IDENTIFIER, admins, collateralWhitelist, ctf, getExpectedPayouts, getLatestUpdate, getQuestion, getUpdates, initialize, isAdmin, isFlagged, isInitialized, optimisticOracle, questions, ready, updates } from './functions.js'
...
export class Contract extends ContractBase {
    ...
    SAFETY_PERIOD() {
        return this.eth_call(SAFETY_PERIOD, {})
    }
