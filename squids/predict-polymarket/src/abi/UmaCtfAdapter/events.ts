...
export const QuestionEmergencyResolved = event('0x6edb5841a476c9c29c34a652d1a44f785fe71a6157a3da9a6a6a589a1bd2945a', {
    questionID: indexed(bytes32),
    payouts: array(uint256),
})
export type QuestionEmergencyResolvedEventArgs = EParams<typeof QuestionEmergencyResolved>
