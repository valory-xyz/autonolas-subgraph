...
export const EMERGENCY_SAFETY_PERIOD = func('0x1cfaeaaf', {}, uint256)
export type EMERGENCY_SAFETY_PERIODParams = FunctionArguments<typeof EMERGENCY_SAFETY_PERIOD>
export type EMERGENCY_SAFETY_PERIODReturn = FunctionReturn<typeof EMERGENCY_SAFETY_PERIOD>
...
/** emergencyResolve(bytes32,uint256[]) */
export const emergencyResolve = func('0x9ce7c0e0', {
    questionID: bytes32,
    payouts: array(uint256),
})
export type EmergencyResolveParams = FunctionArguments<typeof emergencyResolve>
export type EmergencyResolveReturn = FunctionReturn<typeof emergencyResolve>
...
export const getQuestion = func('0x58c039cd', {
    ...
    liveness: uint256,
    emergencyResolutionTimestamp: uint256,
    resolved: bool,
    paused: bool,
    reset: bool,
    refund: bool,
