...
import os
PG_CONTAINER = os.environ.get("PG_CONTAINER", "predict-polymarket-squid-db")
...
if problems:
    print("note: the squid is built from the LATEST subgraph code; if the"
          " deployed subgraph is an older build, these differences are data"
          " MISSING on the subgraph side. See MIGRATION.md, 'Interpreting"
          " known discrepancy classes'.")
