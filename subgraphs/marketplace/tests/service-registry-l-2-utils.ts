...
export function createActivateRegistrationEvent(
  ...
  let activateRegistrationEvent =
    changetype<ActivateRegistration>(newMockEvent())
...
export function createCreateMultisigWithAgentsEvent(
  ...
  let createMultisigWithAgentsEvent =
    changetype<CreateMultisigWithAgents>(newMockEvent())
